//
//  CheckListFreeUITests.swift
//  CheckListFreeUITests
//
//  Created by Igor Mikhalev on 23/07/2019.
//  Copyright © 2019 LeraHome. All rights reserved.
//

import XCTest

class CheckListFreeUITests: XCTestCase {
    ...
    func testAddOne() {
        ...
        app.textFields["New task"].typeText("Hui")
        app.alerts["Create new task"].buttons["Create"].tap()
    }
    
    func testCheckOnField(){
        let app = XCUIApplication()
